...
internal class MatrixTests
{
    ...
    private static IEnumerable<TestCaseData> DimensionalMismatchMatrices()
    {
        ...
        yield return new TestCaseData(mat1, (Matrix<int>)[[1, 2, 3], [4, 5, 6]]);
        yield return new TestCaseData(mat1, (Matrix<int>)[[1, 2], [4, 5], [7, 8]]);
        yield return new TestCaseData(mat1, (Matrix<int>)[[2, 2, 3], [4, 5, 6], [7, 8, 9]]);
    }
    
    [TestCaseSource(nameof(DimensionalMismatchMatrices))]
    public void DimensionalMismatchMatrixComparisons(Matrix<int> mat1, Matrix<int> mat2)
    {
        Assert.That(mat2, Is.Not.EqualTo(mat1));
    }

    [TestCase(new[]{1,2,3,4,5,6,7,8,9}, 3, 3, ExpectedResult = new[]{1,5,9}, TestName = "3x3 Diagonal")]
    [TestCase(new[]{1,2,3,4,5,6}, 3, 2, ExpectedResult = new[]{1,4}, TestName = "3x2 Diagonal")]
    [TestCase(new[]{1,2,3,4,5,6}, 2, 3, ExpectedResult = new[]{1,5}, TestName = "2x3 Diagonal")]
